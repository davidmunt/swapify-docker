...
import { IssueConversationService } from 'src/issues_conversation/issues_conversation.service';
...
export class FilesController {
  ...
  @Post('issues_conversation/:id')
  @UseInterceptors(FilesInterceptor('file'))
  async uploadIssueConversationFiles(
    @UploadedFiles() files: Express.Multer.File[],
    @Param('id') issueConversationId: string,
  ) {
    console.log(files);
    const response = [];
    for (const file of files) {
      ...
      console.log(fileId);
      await this.issueConversationService.addImageToIssueConversation(issueConversationId, file);
      const fileResponse = {
        originalname: file.originalname,
        encoding: file.encoding,
        mimetype: file.mimetype,
        ...
        uploadDate: file.uploadDate,
        contentType: file.contentType,
        issueConversationId: issueConversationId,
      };
